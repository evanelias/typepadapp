"""
Copied from Django trunk r10617. Better than the version in
1.0.2 because it accurately ignores ajax requests. This whole
file is unnecessary if when we upgrade to a newer version of
Django.
